...
import { AuditResultEnum } from 'src/auth/enums/audit-result.enum';
import { AuditSourceEnum } from 'src/auth/enums/audit-source.enum';
import { ActivityLogEvent } from 'src/auth/interfaces/activity-log-event.interface';
